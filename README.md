...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/jupyter-releaser-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=15222&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/jupyter-releaser-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `jupyter-releaser` can be installed with:

```
conda install jupyter-releaser
```

It is possible to list all of the versions of `jupyter-releaser` available on your platform with:
